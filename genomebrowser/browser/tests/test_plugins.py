...
class MyAdminTestCase(TransactionTestCase):
    ...
    def setUp(self) -> None:
        ...
        self.annotator.config['plugins.hmmsearch_tigrfam.conda_env'] = 'genomedepot_hmmsearch'
        ...
        self.annotator.config['plugins.hmmsearch_pfam.conda_env'] = 'genomedepot_hmmsearch'
