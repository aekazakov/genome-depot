...
urlpatterns = [
    ...
    path('searchannotationajax/', views.AnnotationSearchResultsAjaxView.as_view(), name='searchannotationajax'),
    path('loadingsearchresult/',views.AnnotationSearchResultsAjaxView.ajax_view,name="loadingannotations"),
