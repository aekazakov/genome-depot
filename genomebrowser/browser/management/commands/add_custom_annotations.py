...
class Command(BaseCommand):
    help = """For protein sequences uploaded to Django database, this program adds annotations from tab-separated file and writes the annotations to the database.
