...
pip install "django==3.2.6" django_admin_shortcuts django_cors_headers django_q django_debug_toolbar openpyxl "parasail==1.2.4" biopython toytree urllib3 mysqlclient plotly pandas python-decouple --no-cache-dir
deactivate
...
echo "core.poem_command = $TOPDIR/external_tools/POEM_py3k/bin/run_poem_cgcms.sh" >> configs.txt
...
echo "plugins.genomad.genomad_db = $TOPDIR/external_refdata/geNomad/genomad_db" >> configs.txt
